...
let info =
  [ "project-name", "XenomorphProvider"
    ...
    "project-github", "http://github.com/dmitry-a-morozov/FSharp.Data.XenomorphProvider"
    "project-nuget", "http://www.nuget.org/packages/XenomorphProvider" ]
